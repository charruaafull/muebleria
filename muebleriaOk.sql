...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-04-2019 a las 00:32:48
...
--
-- Estructura de tabla para la tabla `loc_tbl`
--

CREATE TABLE `loc_tbl` (
  `Id_Loc` int(11) NOT NULL,
  `Pro_Loc` int(11) NOT NULL,
  `Nom_Loc` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `loc_tbl`
--

INSERT INTO `loc_tbl` (`Id_Loc`, `Pro_Loc`, `Nom_Loc`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
CREATE TABLE `maderas` (
  ...
  `Cod_Mad` int(11) NOT NULL,
  `Img_Mad` varchar(40) NOT NULL,
  `Sub_Mad` int(11) NOT NULL,
  `Ssc_Mad` int(11) NOT NULL,
  `Tce_Mad` int(11) NOT NULL,
  `Stc_Mad` int(11) NOT NULL,
  `Prc_Mad` int(11) NOT NULL,
  `Prp_Mad` int(11) NOT NULL
...
CREATE TABLE `productos` (
  ...
  `Cod_Mue` int(12) NOT NULL,
  `Nom_Mue` varchar(50) NOT NULL,
  `Des_Mue` varchar(600) NOT NULL,
  `Med_Mue` varchar(100) NOT NULL,
  `Col_Mue` varchar(50) NOT NULL,
  `Pro_Mue` int(3) NOT NULL,
  `Pco_Mue` float NOT NULL,
  `Uti_Mue` int(11) NOT NULL,
  `Pre_Mue` float NOT NULL,
  `Pr2_Mue` int(11) NOT NULL,
  `Out_Mue` int(11) NOT NULL,
  `Im1_Mue` varchar(50) NOT NULL,
  `Cat_Mue` int(4) NOT NULL,
  `Sca_Mue` int(4) NOT NULL,
  `Im2_Mue` varchar(50) NOT NULL,
  `Im3_Mue` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `productos` (`Id_Mue`, `Cod_Mue`, `Nom_Mue`, `Des_Mue`, `Med_Mue`, `Col_Mue`, `Pro_Mue`, `Pco_Mue`, `Uti_Mue`, `Pre_Mue`, `Pr2_Mue`, `Out_Mue`, `Im1_Mue`, `Cat_Mue`, `Sca_Mue`, `Im2_Mue`, `Im3_Mue`) VALUES
(43, 9, '9', '9', '9', '9', 9, 9, 9, 9, 9, 95, '', 1, 1, '', ''),
(44, 1, '2', '3', '3', '3', 9, 1, 3, 1.03, 3, 3, '1-1.jpg', 1, 1, '1-2.jpg', '1-3.jpg');
...
CREATE TABLE `proveedores` (
  ...
  `Pro_Prov` int(3) NOT NULL,
  `Loc_Prov` int(4) NOT NULL,
  `Ref_Prov` varchar(600) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `proveedores` (`Id_Prov`, `Nom_Prov`, `Pro_Prov`, `Loc_Prov`, `Ref_Prov`) VALUES
(9, 'Maderas Amiano', 6, 445, 'Cobran 10 % recargo'),
(10, 'Maderas Córdoba', 22, 2104, 'Test');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pro_tbl`
--
...
--
-- Volcado de datos para la tabla `pro_tbl`
--

INSERT INTO `pro_tbl` (`Id_Pro`, `Nom_Pro`) VALUES
(1, 'Buenos Aires'),
(2, 'Buenos Aires-GBA'),
(3, 'Capital Federal'),
(4, 'Catamarca'),
...
INSERT INTO `subcategorias` (`Id_Sub`, `Cat_Sub`, `Nom_Sub`) VALUES
(1, 1, 'Sillas'),
(4, 2, 'Mesas1'),
(8, 1, 'Armarios');
...
--
-- Estructura de tabla para la tabla `usu_tbl`
--

CREATE TABLE `usu_tbl` (
  `Id_Usu` int(2) NOT NULL,
  `Nom_Usu` varchar(10) NOT NULL,
  `Ape_Usu` varchar(20) NOT NULL,
  `Psw_Usu` varchar(15) NOT NULL,
  `Eml_Usu` varchar(11) NOT NULL,
  `Use_Usu` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `usu_tbl`
--

INSERT INTO `usu_tbl` (`Id_Usu`, `Nom_Usu`, `Ape_Usu`, `Psw_Usu`, `Eml_Usu`, `Use_Usu`) VALUES
(19, 'Brian', 'Oroño', 'admin', 'orobrian10@', 'superadmin'),
(20, 'Cesar', 'Monsalvo', '365298a', 'ces@as.com', 'cesar'),
(22, 'neri', 'neri', '365298a', 'neri6@as.co', 'neri');
...
ALTER TABLE `productos`
  ...
  ADD UNIQUE KEY `Cod_Mue` (`Cod_Mue`);
...
--
-- Indices de la tabla `usu_tbl`
--
ALTER TABLE `usu_tbl`
  ADD PRIMARY KEY (`Id_Usu`),
  ADD UNIQUE KEY `Use_Usu` (`Use_Usu`);
...
--
-- AUTO_INCREMENT de la tabla `loc_tbl`
--
ALTER TABLE `loc_tbl`
  MODIFY `Id_Loc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2383;

--
-- AUTO_INCREMENT de la tabla `maderas`
--
ALTER TABLE `maderas`
  MODIFY `Id_Mad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `productos`
--
ALTER TABLE `productos`
  MODIFY `Id_Mue` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
-- AUTO_INCREMENT de la tabla `pro_tbl`
--
ALTER TABLE `pro_tbl`
  MODIFY `Id_Pro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- AUTO_INCREMENT de la tabla `usu_tbl`
--
ALTER TABLE `usu_tbl`
  MODIFY `Id_Usu` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
COMMIT;
